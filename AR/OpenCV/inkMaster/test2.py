...
if __name__ == '__main__':
    # Read source image.
    im_src = cv2.imread("C:\\Users\\Manthika\\Desktop\\opencvtest\\homography\\first-image.jpg");
    size = im_src.shape
    ...
    im_dst = cv2.imread("C:\\Users\\Manthika\\Desktop\\opencvtest\\homography\\times-square.jpg");
